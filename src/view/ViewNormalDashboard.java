 ...
 * @author Pedro Santos
 */
public class ViewNormalDashboard extends javax.swing.JFrame {

    /**
     * Creates new form ViewAdmDashboard
     */
    public ViewNormalDashboard() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/book-stack-icon-256.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewNormalDashboard.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewNormalDashboard().setVisible(true);
            }
        });
    }
