...
public class ExcluirCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        labelEndereco.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
    ...
    private void excluirBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excluirBtnActionPerformed
        ...
        try {
            ...
            if (dao.deleteClient(Integer.parseInt(labelId.getText()))) {
    ...
    private void pesquisarBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_pesquisarBtnActionPerformed
        ...
        try {
            dao = new ClientDAO();
            cliente = dao.findClient(sql, pesquisaInput.getText());

            if (cliente != null) {
                labelId.setText(Integer.toString(cliente.getId()));
                labelNome.setText(cliente.getName());
                labelCpf.setText(cliente.getCpf());
                labelEndereco.setText(cliente.getAddress());
