...
public class ViewPesquisarUsuarios extends javax.swing.JInternalFrame {
        ...
        private void pesquisarBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_pesquisarBtnActionPerformed
                ...
                if (rbId.isSelected()) {
                        sql = "SELECT * from usuario WHERE id=" + pesquisaInput.getText();
                } else if (rbNome.isSelected()) {
                        sql = "SELECT * from usuario WHERE nome LIKE '%" + pesquisaInput.getText() + "%'";
                } else if (rbCpf.isSelected()) {
                        sql = "SELECT * from usuario WHERE cpf=" + pesquisaInput.getText();
                } else if (rbLogin.isSelected()) {
                        sql = "SELECT * from usuario WHERE login_usuario LIKE '%" + pesquisaInput.getText() + "%'";
                }
                ...
                try {
                        ...
                        for (User user : users) {
                                Object[] userData = { user.getId(), user.getName(), user.getCpf(), user.getPhone(),
                                                user.getEmail(),
                                                user.getUsername() };
