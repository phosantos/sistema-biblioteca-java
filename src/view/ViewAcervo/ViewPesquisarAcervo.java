...
public class ViewPesquisarAcervo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tableItens.setCellSelectionEnabled(true);
        ...
        private void pesquisarBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_pesquisarBtnActionPerformed
                ...
                if (rbId.isSelected()) {
                        sql = "SELECT * from acervo WHERE id=" + pesquisaInput.getText();
                } else if (rbTitulo.isSelected()) {
                        sql = "SELECT * from acervo WHERE titulo LIKE '%" + pesquisaInput.getText() + "%'";
                } else if (rbAutor.isSelected()) {
                        sql = "SELECT * from acervo WHERE autor LIKE '%" + pesquisaInput.getText() + "%'";
                } else if (rbEditora.isSelected()) {
                        sql = "SELECT * from acervo WHERE editora LIKE '%" + pesquisaInput.getText() + "%'";
                } else if (rbCategoria.isSelected()) {
                        sql = "SELECT * from acervo WHERE categoria LIKE '%" + pesquisaInput.getText() + "%'";
                }

                if (mostrarDisponiveis.isSelected()) {
                        sql = sql + " and disponibilidade=true";
                }
